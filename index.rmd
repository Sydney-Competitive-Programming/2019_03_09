...
library(data.table)
barplot(df_summ2$pts, names.arg = df_summ2$name, cex.axis = 0.3, angle = 45)
```
...
# Points from golf
```{r echo=FALSE}
DT::datatable(golf_scrs[order(pts_golf, decreasing = T),.(name, pts = pts_golf)])
```
